...
contract gnsPool is IPool, ERC721{
    ...
    //hf that liqudated loans need to be in after collateral is swapped for loans to be made before penalty is taken
     ...
     * add require that checks wether amount would be over max hf or not
